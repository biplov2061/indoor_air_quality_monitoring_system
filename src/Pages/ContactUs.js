...
// import contactStyles from "./ContactPage.css";
...
const validate = () =>{
   ...
   if(!formData.name.trim()){
    ...
    if(!formData.email){
       ...
       else if(!/^\S+@\S+\.\S+$/.test(formData.email)){   //regex code to validate email
      ...
      <div className="contact-content">
        ...
        <div className="contact-form">
          ...
          <form onSubmit={handleSubmit}> 
            ...
            <input type="text" placeholder="98XXXXXXXX" name="phone" value={formData.phone} onChange={handleChange}/>
            {errors.phone && <p className="errors">{errors.phone}</p>}

            <label>Email</label>
            <input type="email" placeholder="your@email.com" name="email" value={formData.email} onChange={handleChange}/>
            {errors.email && <p className="errors">{errors.email}</p>}

            <label>Message</label>
            <textarea placeholder="Write your message..." name="message" value={formData.message} onChange={handleChange}></textarea>
